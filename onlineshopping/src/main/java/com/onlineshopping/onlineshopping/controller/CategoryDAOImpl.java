...
public class CategoryDAOImpl implements CategoryDAO {
	...
	public Category get(int id) {
		// we need to return a category based on its id
		// se use enhance for loop
		for(Category category : categories) {  // categories is our collection
		...
		return null;  // if there is not category for and id itwill return null
	}
